...
public class EmprestimoLivros {
    ...
    public static Emprestimo emprestarLivro(Livro livro, Usuario usuario, List<Livro> livrosEmprestados) {
        ...
        // Adiciona o livro à lista de livros emprestados pelo usuário
...
public static Emprestimo realizarEmprestimo(List<Livro> livros, List<Usuario> usuarios, List<Emprestimo> emprestimos, Scanner scanner) {
    ...
    return emprestarLivro(livroSelecionado, usuarioSelecionado, livros);
}
}
